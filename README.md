...
## Description 
Have some burgers! This website is design for you to input a burger, any burger, of your choice just so that you can devour it when you want. The UI is simple enough. In the text field right below “Enter the name of the burger” type in the name of a burger you like. After, click the “Add New Burger” button. When doing so, the burger will appear under the “Available” header with an “Eat it” button. Click that button whenever you feel like devouring it, at least digitally. Devouring a burger this way is the best calorie and fat free way to consume a burger, guaranteed!
...
## Usage
Use this app to devour any burger of your preference! In a digital, less-calorie sort of way.
